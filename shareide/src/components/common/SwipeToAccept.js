  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.actionSide, styles.acceptSide, { opacity: acceptOpacity }]}>
        ...
        <Text style={[styles.acceptText, { color: colors.success }]}>{acceptText}</Text>
      </Animated.View>

      {/* Reject side (left) */}
      <Animated.View style={[styles.actionSide, styles.rejectSide, { opacity: rejectOpacity }]}>
        <Text style={[styles.rejectText, { color: colors.error }]}>{rejectText}</Text>
        ...
        >
          ...
          <Animated.View
            ...
            style={[
              ...
              swiping === 'accept' && { shadowColor: colors.success, shadowOpacity: 0.5 },
              swiping === 'reject' && { shadowColor: colors.error, shadowOpacity: 0.5 },
            ]}
          >
            <LinearGradient
              colors={
