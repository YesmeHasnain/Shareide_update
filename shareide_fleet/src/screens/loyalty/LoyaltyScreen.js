                ...
                {dashboard?.recent_points?.slice(0, 5).map((point, index) => (
                  <View key={index} style={styles.activityItem}>
                    ...
                    <View style={styles.activityInfo}>
                      ...
                      <Text style={styles.activityDate}>{new Date(point.created_at).toLocaleDateString()}</Text>
                    </View>
            ...
            <View style={styles.rewardsGrid}>
              {rewards.map((reward) => (
                <View key={reward.id} style={styles.rewardCard}>
                  ...
                  <TouchableOpacity
                    style={[styles.redeemButton, !reward.can_redeem && styles.redeemButtonDisabled]}
                    onPress={() => handleRedeemReward(reward.id, reward.points_required)}
                    disabled={!reward.can_redeem}
                  >
                    <Text style={[styles.redeemButtonText, !reward.can_redeem && styles.redeemButtonTextDisabled]}>
            ...
            <View style={styles.achievementsList}>
              {achievements.map((achievement) => (
                <View key={achievement.id} style={styles.achievementCard}>
                  <View style={[styles.achievementIcon, achievement.is_completed && styles.achievementCompleted]}>
                    <FontAwesome5 name="trophy" size={20} color={achievement.is_completed ? '#FFF' : COLORS.textLight} />
                  </View>
                  <View style={styles.achievementInfo}>
                    ...
                    <View style={styles.achievementProgress}>
                      <View style={styles.achievementProgressBar}>
                        <View style={[styles.achievementProgressFill, { width: `${achievement.progress_percentage}%` }]} />
                      </View>
                  ...
                  <View style={styles.achievementReward}>
                    <Ionicons name="star" size={14} color={COLORS.primary} />
                    <Text style={styles.achievementRewardText}>{achievement.points_reward}</Text>
                  </View>
                </View>
              ))}
            </View>
